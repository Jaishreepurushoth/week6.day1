...
public class EditLead extends LeafTabs {

	@Test(dependsOnMethods="week6.day1.CreateLead.create")
	public void EditLeadMethod() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//label[text()='First name:'])[3]/following::input[@name='firstName']")).sendKeys("priya"); //enter the first name
